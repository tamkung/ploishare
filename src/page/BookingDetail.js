                                ...
                                <div className="mt-2" style={{ textAlign: "center" }}>
                                    ...
                                    <Modal okButtonProps={{ style: { display: 'none' } }} title="เงื่อนไขและข้อกำหนด" open={isModalOpen} onCancel={handleCancel}>
                                        <div>
                                            ...
                                            <p>- ระบุเวลาใช้เริ่มต้น - สิ้นสุด ให้ชัดเจน</p>
                                            ...
                                            <p>- ผู้ใช้งานจะต้องกรอกใบขออนุญาตและต้องเซ็นรับรองจากหัวหน้า</p>
                                            <p>- ผู้ใช้งานสามารถส่งใบขออนุญาตย้อนหลังได้ผ่านระบบ "ปล่อยShared"</p>
                                            <strong>วิธีส่งใบอนุญาตย้อนหลัง</strong>
                                            <p>1. คลิกที่ปุ่ม "เมนู" ทางขวาล่าง เลือก "รายการจอง"</p>
                                            <p>2. ตรวจสอบรายการจจอง รุ่นรถ ป้ายทะเบียน และวันที่ใช้งานให้ถูกต้อง หากผิดพลาดให้กดยกเลิกทางขวาบนของรายการ และทำการจองใหม่ ( หากเร่งด่วนกรุณาติดต่อเจ้าหน้าที่ )</p>
                                            <p>3. กดปุ่ม "เพิ่มใบขออนุญาต"</p>
                                            <p>4. เลือกไฟล์ ใบขออนุญาต และกด "ตกลง"</p>
                                            <br />
                                            <strong>3. การรับและคืนกุญแจรถ</strong>
                                            <p>- รับกุญแจรถ ที่แผนกบริการกลาง อ.1/1 (เบอร์ 5167, 5348)</p>
                                            <p>- รับรถ , คืนรถ ที่แผนกบริการกลาง หรือตรงจุดรปภ.ประจำอาคาร 1</p>
                                            <br />
                                            <strong>4. การใช้รถ</strong>
                                            <p>- เมื่อ Start รถทุกครั้ง ต้องเช็คว่ากล้องติดหน้ารถทำงานได้ 100%</p>
                                            <p>- ก่อนใช้งานรถ และ หลังการใช้งานรถ ให้สำรวจสภาพรถ ว่ามีรอยหรือชำรุดส่วนใดหรือไม่ หากมีปัญหาให้ถ่ายรูป และแจ้งผู้ดูแล (ได้มาจากการส่งคืนรถของคนก่อนหน้า)</p>
                                            <p>- กรณีคืนรถไม่ตรงเวลา ให้ติดต่อผู้ดูแล (ควรเผื่อเวลา 1 ชม. ขึ้นไป  เนื่องจากอาจมีผู้ใช้งานรอต่อคิว)</p>
                                            <p>- ผู้ใช้จะต้องกรอกเลขไมค์ผ่านเว็บไซต์ "ปล่อยShared" ทั้งก่อนใช้งานและหลัง ค่าน้ำมันจะคำนวณจากส่วนนี้และเรียกเก็บหน่วยงานภายหลัง</p>
                                            <p>- พึงระวัง ความรับผิดชอบในการซ่อมรถจะประเมินจากข้อมูลและหลักฐานแถวๆนี้แหละ</p>

                                            <p>#หากคิดว่ามีปัญหาให้ติดต่อผู้ดูแลรถหรือทางผู้ดูแลได้เลยค่ะ</p>
                                            <br />
                                            <strong>5. ขั้นตอนการใช้งาน</strong>
                                            <p>#หากผู้ดูแลอนุมัติการจอง สถานะของรายการจองนั้นจะเป็น "อนุมัติแล้ว" และมีปุ่ม "เปิดการใช้งาน" ปรากฎ</p>
                                            <p>##ผู้ใช้งานสามารถส่งใบขออนุญาตย้อนหลังได้ (แต่ต้องส่งนะ เพราะระบบจะบันทึกว่าท่านยังไม่ได้ส่ง)</p>

                                            <p>1. คลิกที่ปุ่ม "เมนู" ทางขวาล่าง เลือก "รายการจอง"</p>
                                            <p>2. ตรวจสอบรายการจจอง รุ่นรถ ป้ายทะเบียน และวันที่ใช้งานให้ถูกต้อง หากผิดพลาดให้กดยกเลิกทางขวาบนของรายการ และทำการจองใหม่ ( หากเร่งด่วนกรุณาติดต่อเจ้าหน้าที่ )</p>
                                            <p>3. กดปุ่ม "เปิดการใช้งาน" และกรอกเลขไมล์เริ่มต้นก่อนใช้งาน (เลขไมล์จะทำการนับต่อจากผู้ใช้รถก่อนหน้า)</p>
                                            <p>4. ขณะคืนรถ ให้กดปุ่ม "ปิดการใช้งาน" และกรอกเลขไมลล์ล่าสุดหลังใช้งาน</p>
                                        </div>
                                    </Modal>
                                </div>
                                <Button
